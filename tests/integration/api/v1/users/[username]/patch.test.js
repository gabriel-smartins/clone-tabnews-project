...
describe("PATCH to api/v1/users/[username]", () => {
  describe("Anonymous user", () => {
    ...
    test("With new 'password'", async () => {
      ...
      const passwordMatches = await password.compare("newPassword2", userInDatabase.password)
      const passwordDoesNotMatches = await password.compare("newPassword1", userInDatabase.password)
